...
public class CreateExerciseResponseDto {
    ...
    public CreateExerciseResponseDto(
            Long id,
            String title,
            String description,
    ...
    public CreateExerciseResponseDto(Builder builder) {
        this.id = builder.id;
    ...
    public static class Builder {
        ...
        public CreateExerciseResponseDto build() {
            return new CreateExerciseResponseDto(this);
        }
    }
}
