...
@Component
public class TitleOptionalValidator implements ConstraintValidator<TitleOptionalValidation, String> {
    @Autowired
    ...
    @Override
    public void initialize(TitleOptionalValidation constraintAnnotation) {
