...
@Component
public class FullNameOptionalValidator implements ConstraintValidator<FullNameOptionalValidation, String> {
    @Autowired
    UserValidationUtil userValidationUtil;

    @Override
    public void initialize(FullNameOptionalValidation constraintAnnotation) {
